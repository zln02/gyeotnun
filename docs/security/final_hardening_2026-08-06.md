...
> **2026-08-16 갱신(#33 3·4단계)**: 아래 "워커 1개" 판단은 그 시점 기준이다.
> 확인 기록을 Postgres 로 옮긴 뒤(3단계) 전제가 사라졌고, 격리 환경에서 2워커로
> POST→evidence→dialogue 전체 흐름에 404 가 0건임을 실측한 뒤 **워커를 2로 올렸다**
> (`docs/reports/2026-08-16_동시접속_4단계.txt`). 아래 서술은 당시 기록으로 남긴다.
