...
export default function BottomNav({ active, onTap }) {
  return (
    <nav className="bottom-navigation" aria-label="주요 메뉴">
      <div className="bottom-navigation__bar">
        ...
        <span className="bottom-navigation__center-space" aria-hidden="true" />
        ...
        <button type="button" className="bottom-navigation__check" aria-label="바로 확인" onClick={() => onTap('fab')}>
          <span className="bottom-navigation__check-icon"><img src={navCheckIcon} alt="" aria-hidden="true" /></span>
          <span className="bottom-navigation__check-label">바로<br />확인</span>
        </button>
      </div>
    </nav>
  )
