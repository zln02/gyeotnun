  ...
  return (
    <section className="confirm-cluster" aria-label="확인 방법 고르기">
      <div className="confirm-cards">
        <ConfirmCard icon={icPhoto} iconClass="confirm-card-icon--photo" title="사진 확인" desc="클릭하여 사진 선택하기" onClick={onPhoto} />
        <ConfirmCard icon={icLink} iconClass="confirm-card-icon--link" title="링크 확인" desc="클릭하여 주소 붙여넣기" onClick={onLink} />
        <ConfirmCard icon={icSms} iconClass="confirm-card-icon--sms" title="문자 확인" desc="클릭하여 내용 입력하기" onClick={onText} />
      </div>
    </section>
  )
}
